...
Give it a name: vna1.vcf.lab / DHCP / mgmt network / storage -> save (you can have just one)
...
Build -> Lifecycle -> fleet instance -> Management Domain -> manage components -> AVI Install -> Wizzard -> small -> Passwords -> Node IP (x3)
